...
class TraitorGamePage extends StatefulWidget {
  ...
  TraitorGamePage({required this.users, required this.gameRoomName, required this.nameRoom, required this.nameUser});
            ...
            Column(
              children: List.generate(
                ...
                (index) => ElevatedButton(
                  onPressed: () {
                    if (widget.users.firstWhere((user) => user.isTraitor).isTraitor) {
